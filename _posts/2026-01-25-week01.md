...
#### 3. PyTorch  
As a computer science and data science student, I frequently use PyTorch in machine learning–related courses and personal projects. Its open-source nature allows me to inspect internal implementations and understand how high-level abstractions are built on top of lower-level operations.

#### 4. Wikipedia  
Wikipedia is one of the most visible examples of open-source collaboration beyond software. It demonstrates how a global community can collectively build and maintain a large, shared knowledge base. As a user, I rely on it constantly; as a concept, it reinforces my belief that open collaboration can produce resources that are both widely accessible and continuously improving.
